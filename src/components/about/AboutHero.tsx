...
export default function AboutHero() {
  return (
    <section
      className=" flex flex-col justify-center px-12 py-30 relative overflow-hidden"
      style={{
        backgroundImage:
    ...
    >
      {/* Radial glow */}
      <div className="absolute -top-48 -right-48 w-[700px] h-[700px] rounded-full pointer-events-none bg-[radial-gradient(circle,rgba(0,212,200,0.07)_0%,transparent_65%)]" />

      <SectionTag label="About Graphix" />

      <h1 className="font-syne font-extrabold text-[clamp(3rem,7vw,6rem)] leading-[0.95] tracking-tight max-w-[860px] text-white">
        We built the
        <br />
        <em
      ...
      <p className="mt-7 max-w-[500px] text-[#6b7280] text-base leading-[1.75]">
